...
from elde import chtool

__CHANNEL_USERNAME__ = "CHTOOL"
__GROUP_USERNAME__   = "CH COMUNITY"
...
def banner(console):
    ...
    brand_name = figlet_format('CHtool', font='bloody')
    colors = [
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: In order to chtool this account with .'))
